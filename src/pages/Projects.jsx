...
const Projects = () => (
    <div className="bg-white dark:bg-gray-800 dark:border dark:border-gray-700 p-8 rounded-2xl shadow-sm">
        <div className="pb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">Several projects that I have worked on, both private and open source.</p>
        </div>
            ...
            {portfolioData.projects.map(project => (
                <Link to={`/projects/${project.slug}`} key={project.id} className="group block">
                    <div className="relative rounded-xl overflow-hidden mb-4">
                        ...
                        {project.login && (
                             <div className="absolute top-3 right-3 bg-gray-700 text-white text-xs font-semibold px-2.5 py-1 rounded-full flex items-center gap-1">
