...
// Varian animasi yang sama dengan halaman lain untuk konsistensi
    ...
    return (
        ...
        >
            <motion.div variants={containerVariants} initial="hidden" animate="visible">
                ...
                <motion.div variants={itemVariants} className="flex flex-wrap gap-4 justify-between items-center mb-8">
                ...
                <motion.div variants={itemVariants} className="prose dark:prose-invert max-w-none text-gray-600 dark:text-gray-400 leading-relaxed">
