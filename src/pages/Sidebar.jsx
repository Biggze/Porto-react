      ...
      <aside className="lg:col-span-3">
            <div className="bg-white dark:bg-gray-800 dark:border dark:border-gray-700 p-6 rounded-2xl shadow-sm sticky top-8">
                <div className="flex flex-col items-center text-center">
                    <img className="w-24 h-24 rounded-full mb-4 object-cover" src="https://placehold.co/100x100/333333/ffffff?text=SB" alt={`Foto profil ${portfolioData.profile.name}`} />
                ...
                <nav className="mt-8"><ul className="space-y-2">{navItems.map(item => <NavItem key={item.label} {...item} />)}</ul></nav>
