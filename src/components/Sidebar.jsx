...
const Sidebar = ({ theme, onThemeToggle }) => {
    const navItems = [
      ...
      { icon: <MessageSquare size={20} />, label: 'Chat Room', to: '/chatroom' },
      { icon: <Mail size={20} />, label: 'Contact', to: '/contact' },
    ];
  
    return (
      <aside className="lg:col-span-3">
        <div className="bg-white dark:bg-gray-800 dark:border dark:border-gray-700 p-6 rounded-2xl shadow-sm sticky top-8">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="text-xl font-bold text-gray-900 dark:text-white flex items-center">
              ...
              <svg className="w-5 h-5 ml-1 text-blue-500" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
            </h1>
            <p className="text-sm text-gray-500 dark:text-gray-400">{portfolioData.profile.handle}</p>
          </div>
          <div className="flex items-center space-x-2 mt-6">
            <button className="w-full bg-blue-500 text-white px-4 py-2.5 rounded-lg text-sm font-semibold hover:bg-blue-600 transition-colors duration-200">Hire me</button>
            <button onClick={onThemeToggle} className="w-auto border border-gray-300 dark:border-gray-600 p-2.5 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
